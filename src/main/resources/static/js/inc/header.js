...
// let loginContainerTop = (($(window).height() -
// $(".login-form").outerHeight()) / 2 + $(window).scrollTop()) + "px"
// let loginContainerLeft = (($(window).width() - $(".login-form").outerWidth())
// / 2 + $(window).scrollLeft()) + "px"
//				let loginContainerTop = $("e.target").height() + "px"
//				let loginContainerLeft = $("e.target").width() - $(".login-form").outerWidth() + "px"
